...
class LoggerManager:
    ...
    def log_trade(self, action: str, exchange: str, symbol: str, 
        ...
        self.info(f"Trade executed: {action} {amount} {symbol} @ {price} on {exchange}",
                 **trade_data)
...
class TradingLogger:
    ...
    def log_signal(self, signal_type: str, confidence: float, 
                   kimchi_premium: float, **kwargs):
        """거래 신호 로그"""
        self.logger.info(
    ...
    def log_order(self, order_id: str, exchange: str, symbol: str,
                  side: str, price: float, amount: float, **kwargs):
        """주문 로그"""
        self.logger.info(
