...
from src.utils.alerts import AlertChannel, AlertLevel, alert_manager
from src.utils.logger import log_execution_time, logger, trading_logger
...
def test_basic_logging():
    ...
    # 추가 필드와 함께 로깅
    logger.info("Trade execution started", exchange="upbit", symbol="BTC/KRW", action="BUY")
...
def test_metrics_collection():
    ...
    metrics_collector.record_trade(
        exchange="upbit", symbol="BTC/KRW", side="buy", amount=0.01, price=100000000, success=True
    )
...
async def test_alerts():
    ...
    await alert_manager.send_alert(
        message="System started successfully", level=AlertLevel.INFO, title="System Status"
    )
    ...
    await alert_manager.send_alert(
        ...
        details={"Memory Usage": "85%", "Available": "2GB"},
    )
